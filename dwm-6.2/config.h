...
static const char *fonts[]          = { "Source Code Pro:size=10", "Noto Color Emoji:size=10" };
...
static const char *volmaxcmd[] = { "/bin/bash", "-c", "amixer -D default sset Master Playback 100%; sh ~/.xsetroot.sh" };
...
static Key keys[] = {
	...
	{ WINKEY,                       XK_Up,      spawn,         {.v = brightnessupcmd } },
	{ WINKEY,                       XK_Down,    spawn,         {.v = brightnessdowncmd } },
